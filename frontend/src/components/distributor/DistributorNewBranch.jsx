...
const DistributorNewBranch = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        axios.post("http://localhost:3333/distributor/distributingEntity", newBranchData, {
            headers: {
    ...
    return (
        <div className="mt-8 w-full py-4 px-6 text-left">
            <div className="mx-auto max-w-sm">
                <Link to={`/distributor/${id}`} className="flex items-center gap-4 mt-8 text-lg text-left">
...
export default DistributorNewBranch;