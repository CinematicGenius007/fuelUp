...
const SupplierBranches = () => {
    ...
    useEffect(() => {
        axios.get('http://localhost:3333/supplier/details', {
            headers: {
        ...
        axios.get('http://localhost:3333/supplier/supplyingEntities', {
            headers: {
                authorization: `Bearer ${localStorage.getItem('token')}`
            }
        })
    ...
    return (
        <div className="text-left">
            <div className="mt-8 w-full text-5xl font-bold">Welcome, {supplierInfo.name}</div>
